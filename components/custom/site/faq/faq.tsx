...
export default function FaqSection() {
  return (
    <div className='flex flex-col justify-center items-center h-full w-full'>
      ...
      <Card className='mt-20 p-5 w-[800px] border border-border bg-secondary/30 backdrop-blur-lg supports-[backdrop-filter]:bg-secondary/50'>
      <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="item-1" className='bg-background px-4 rounded-xl border-border border mb-5'>
      ...
      <AccordionItem value="item-2" className='bg-background px-4 rounded-xl border-border border my-5'>
      ...
      <AccordionItem value="item-3" className='bg-background px-4 rounded-xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>Is it animated?</AccordionTrigger>
        <AccordionContent>
          Yes. It&apos;s animated by default, but you can disable it if you prefer.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-4" className='bg-background px-4 rounded-xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>Are there any additional costs I should be aware of?</AccordionTrigger>
        <AccordionContent>
          Yes. It&apos;s animated by default, but you can disable it if you prefer.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-6" className='bg-background px-4 rounded-xl border-border border mt-5'>
