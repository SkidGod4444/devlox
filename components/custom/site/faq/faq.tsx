  ...
  return (
    <div className='flex flex-col justify-center items-center h-full w-full'>
      ...
      <AccordionItem value="item-3" className='bg-background px-4 rounded-2xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>What happens if I&apos;m not satisfied with the final product?</AccordionTrigger>
        <AccordionContent className='text-xl text-muted-foreground'>
      ...
      <AccordionItem value="item-6" className='bg-background px-4 rounded-2xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>Do you offer free services? </AccordionTrigger>
        <AccordionContent className='text-xl text-muted-foreground'>
      ...
      <AccordionItem value="item-7" className='bg-background px-4 rounded-2xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>Do i need to pay any upfront amount?</AccordionTrigger>
        <AccordionContent className='text-xl text-muted-foreground'>
      ...
      <AccordionItem value="item-8" className='bg-background px-4 rounded-2xl border-border border mt-5'>
        <AccordionTrigger className='text-2xl cursor-pointer'>Can i choose developers from your team to hire on my project?</AccordionTrigger>
        <AccordionContent className='text-xl text-muted-foreground'>
