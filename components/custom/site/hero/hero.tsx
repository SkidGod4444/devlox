...
export default function HeroSection() {
  return (
    <div className='flex flex-col z-50 items-center justify-center h-full w-full'>
      <div className='flex items-center justify-center w-[900px] h-full relative'>
      ...
      <span className='text-xl line-clamp-3 w-[900px] mt-4 text-center text-muted-foreground'>I am a passionate and experienced web designer, dedicated to creating visually stunning and highly functional websites. Explore my portfolio to see the power of effective design in action</span>
